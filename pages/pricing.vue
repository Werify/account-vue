    ...
    <div class="mx-auto">
      <div class="max-w-screen-2xl mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">
          Designed for whom safety, security, and privacy is a priority.
        </h2>
        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
          Here at Werify Account we focus on account service where technology, innovation, and
          security can unlock long-term value and drive trust growth, around the web.
        </p>
      </div>
